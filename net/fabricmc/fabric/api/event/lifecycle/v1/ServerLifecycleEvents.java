...
public final class ServerLifecycleEvents {
	 ...
	 *
	 * <p>This occurs before the {@link class_3324 player manager} and any worlds are loaded.
	 */
	...
	public interface SyncDataPackContents {
		 ...
		 * The {@linkplain MinecraftServer#method_34864() server resource manager} is up-to-date when this is called.
		 *
		 ...
		 */
		void onSyncDataPackContents(class_3222 player, boolean joined);
	}

	@FunctionalInterface
	public interface StartDataPackReload {
		void startDataPackReload(MinecraftServer server, class_6860 resourceManager);
	}
	...
	public interface EndDataPackReload {
		 ...
		 */
		void endDataPackReload(MinecraftServer server, class_6860 resourceManager, boolean success);
	}
