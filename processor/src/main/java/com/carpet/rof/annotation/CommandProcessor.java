...
@SupportedAnnotationTypes("com.carpet.rof.annotation.CarpetCommand")
...
public class CommandProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations,
        ...
        Set<? extends Element> elements =
                roundEnv.getElementsAnnotatedWith(CarpetCommand.class);
    ...
    private void validateStaticMethod(TypeElement type) {
        boolean found = false;
        ...
        if (!found) {
            processingEnv.getMessager().printMessage(
                    ...
                    "Classes annotated with @RulesSetting must declare: "
