...
public class ROFEvents
{
    ...
    public static final TickTasks<ServerLevel>     WorldTickEndTasks  = new TickTasks<>();

    public static final Event<ServerLevel> WorldStart     = new Event<>();
    public static final Event<ServerLevel> WorldTickBegin = new Event<>();
    public static final Event<ServerLevel> WorldTickEnd   = new Event<>();
}
